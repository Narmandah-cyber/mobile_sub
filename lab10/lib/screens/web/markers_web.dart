...
// Your free OpenTripMap API key
const String otpApiKey = "YOUR_OPENTRIPMAP_API_KEY";

class MarkersScreenWeb extends StatefulWidget {
  const MarkersScreenWeb({super.key});

  @override
  State<MarkersScreenWeb> createState() => _MarkersScreenWebState();
}

class _MarkersScreenWebState extends State<MarkersScreenWeb> {
  ...
  Future<void> searchPlaces() async {
    ...
    final url = "https://api.maptiler.com/maps/streets-v4/style.json?key=5oJtenGwgd5bhnR9IGTS";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Markers — OpenTripMap Web")),
      body: Column(
        children: [
          Padding(
